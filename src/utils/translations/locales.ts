...
export function findLocale(current: Locale | null): Locale | undefined {
 ...
 * @param locale
 */
export const getLocale = (locale: string | string[] | undefined): Locale | typeof UnknownLocale | undefined => {
  if (!locale) {
    return
  }
...
export const withLocale = (
  fn: (locale: Locale, context: GetServerSidePropsContext) => Promise<GetServerSidePropsResult<Record<string, unknown>>>
) => {
