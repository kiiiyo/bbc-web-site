...
const neoImageUrl =
  'https://images.ctfassets.net/od632j3oj9wg/5PaGdo375iueDVFO5kJ95N/76de30b399a0714e0ae71e4944ac0257/Origin_Neo.png'
const mooImageUrl =
  'https://images.ctfassets.net/od632j3oj9wg/7ikoQeUFN3iqcA731292NP/380fe10d2e884113480b5ca3e3e15dd5/Origin_Moo.png'
const smithImageUrl =
  'https://images.ctfassets.net/od632j3oj9wg/480lC6i3c7jZijAmdGoiJ4/aa17263319dbd43cb3c33405db4f504c/Origin_Smith.png'
const oracleImageUrl =
  'https://images.ctfassets.net/od632j3oj9wg/2lFm0XeApAa7uXtugv67m2/02c450d777aaef6f2b94e3ac7c7f4e4e/Origin_Oracle.png'
const trinityImageUrl =
  'https://images.ctfassets.net/od632j3oj9wg/71vvwlzyssUjIGqsKc64wy/3972b9bf8796c9aebe4412b1a8ac6a23/Origin_Trinity.png'
const duJourImageUrl =
  'https://images.ctfassets.net/od632j3oj9wg/2CUVVQBmsWOeZXj4UOY7KW/fae84b7d4ad755c526775021a7486448/Origin_DuJour.png'

export const AvatarSeries: FC = () => {
  return <AvatarSeriesPresenter />
}

export const AvatarSeriesPresenter: FC = () => {
  return (
    <section>
      <div className="bg-neutral-200 border-b-2 border-neutral-200 border-solid">
        <div className="container py-8 px-6 mx-auto md:py-16">
          <div>
            <div className="text-center">
              <h2 className=" text-4xl font-bold">🐻 Bit Bear Avatar Series</h2>
              <p className="mt-4 mb-2 font-bold text-neutral-800">💎 Matic（Polygon）🔗 Network NFT</p>
            </div>
            <div className="flex justify-center items-center mt-16 ">
              <div className="overflow-hidden z-10 p-0 my-0 w-40 rounded-full border-4 border-white">
                <Image
                  className="m-0 w-full h-full"
                  src={neoImageUrl}
                  alt="Bit Bear Avatar Series Neo"
                  layout={'responsive'}
                  width="100%"
                  height="100%"
                />
              </div>
              <div className="overflow-hidden z-10 p-0 my-0 -mx-3 w-40 rounded-full border-4 border-white">
                <Image
                  className="m-0 w-full h-full"
                  src={mooImageUrl}
                  alt="Bit Bear Avatar Series Moo"
                  layout={'responsive'}
                  width="100%"
                  height="100%"
                />
              ...
              <div className="overflow-hidden z-10 p-0 my-0 -mx-3 w-40 rounded-full border-4 border-white">
                <Image
                  className="m-0 w-full h-full"
                  src={smithImageUrl}
                  alt="Bit Bear Avatar Series Smith"
                  layout={'responsive'}
                  width="100%"
                  height="100%"
                />
              ...
              <div className="overflow-hidden z-10 p-0 my-0 -mx-3 w-40 rounded-full border-4 border-white">
                <Image
                  className="m-0 w-full h-full"
                  src={oracleImageUrl}
                  alt="Bit Bear Avatar Series Oracle"
                  layout={'responsive'}
                  height="100%"
                  width="100%"
                />
              ...
              <div className="overflow-hidden z-10 p-0 my-0 -mx-3 w-40 rounded-full border-4 border-white">
                <Image
                  className="m-0 w-full h-full"
                  src={trinityImageUrl}
                  alt="Bit Bear Avatar Series Trinity"
                  layout={'responsive'}
                  width="100%"
                  height="100%"
                />
              ...
              <div className="overflow-hidden z-10 p-0 my-0 -mx-3 w-40 rounded-full border-4 border-white">
                <Image
                  className="m-0 w-full h-full"
                  src={duJourImageUrl}
                  alt="Bit Bear Avatar Series DuJour"
                  layout={'responsive'}
                  width="100%"
                  height="100%"
                />
            ...
            <div className="flex justify-center mt-16">
              <Link href="https://opensea.io/collection/bit-bear-club-avatar-series">
                ...
                >
                  ...
                  <span className="font-bold">Bit Bear Avatar Series</span>
                </a>
              </Link>
            </div>
          </div>
