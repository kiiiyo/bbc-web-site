...
export type TAboutNeoPresenterProps = {
  state: {
    locale: TLocale
    language: TLanguage
  }
  ...
  return (
    <div className="flex flex-col mx-auto mt-8 lg:flex-row lg:mt-24 lg:w-4/5">
      ...
      <div className="w-full lg:pl-10 lg:mt-0 lg:w-1/2">
        ...
        <p className="mt-6 leading-8">{language.page.aboutPage.section.neo.description}</p>
          ...
          <button
            onClick={() => {
              onAvatarClick({
                ...
                bearName: 'neo',
                nftId: 'A0165',
                link: 'https://opensea.io/assets/matic/0x2953399124f0cbb46d2cbacd8a89cf0599974963/85612792707671471240665121138616411211534411599642434463980733234356022149121'
              })
              //
            }}
            className="block overflow-hidden z-10 p-0 my-0 -ml-4 w-24 h-24 rounded-full border-4 border-white"
...
export const AboutNeo: FC = () => {
  ...
  return <AboutNeoPresenter state={{ language, locale }} actions={{ onAvatarClick }} />
}
