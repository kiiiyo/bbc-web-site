          ...
          <button
            onClick={() => {
              onAvatarClick({
                ...
                bearName: 'moo',
                nftId: 'A0002',
                link: 'https://opensea.io/assets/0x495f947276749ce646f68ac8c248420045cb7b5e/85612792707671471240665121138616411211534411599642434463980733056235138449409'
              })
              //
            }}
          ...
          <button
            onClick={() => {
              onAvatarClick({
                ...
                bearName: 'moo',
                nftId: '',
                link: 'https://opensea.io/assets/bit-bear-club-avatar-series?search[stringTraits][0][name]=Name&search[stringTraits][0][values][0]=Moo&search[sortAscending]=true&search[sortBy]=PRICE'
              })
              //
            }}
...
export const AboutMoo: FC = () => {
  ...
  return <AboutMooPresenter state={{ language, locale }} actions={{ onAvatarClick }} />
}
