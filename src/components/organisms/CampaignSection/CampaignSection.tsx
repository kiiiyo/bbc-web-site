  ...
  return (
    <div className="flex flex-col mx-auto mt-24 lg:flex-row lg:w-4/5">
      ...
      <div className="w-full lg:pl-10 lg:mt-0 lg:w-1/2">
        ...
        <h4 className="py-2 mt-12 font-bold tracking-wider text-gray-900">
        ...
        <div className="mt-12">
          <div className="flex relative pb-12">
            ...
            <div className="inline-flex relative z-10 shrink-0 justify-center items-center w-10 h-10 text-white bg-gradient-to-r from-blue-500 to-blue-600 rounded-full">
              <Atoms.TwitterIcon className="w-5 h-5" />
            </div>
          ...
          <div className="flex relative pb-12">
            ...
            <div className="inline-flex relative z-10 shrink-0 justify-center items-center w-10 h-10 text-white bg-gradient-to-r from-blue-500 to-blue-600 rounded-full">
              <Atoms.MailIcon className="w-5 h-5" />
            </div>
            <div className="grow pl-4">
              <h2 className="mb-1 text-3xl font-bold tracking-wider text-gray-900">
                {language.page.campaignPage.section.dm.title}
              </h2>
              <p className="mt-4">{language.page.campaignPage.section.dm.description}</p>
              <p className="mt-4">{language.page.campaignPage.section.dm.secretWord}</p>
            </div>
          </div>
          <div className="flex relative pb-12">
            <div className="inline-flex relative z-10 shrink-0 justify-center items-center w-10 h-10 text-white bg-gradient-to-r from-blue-500 to-blue-600 rounded-full">
              <Atoms.CheckIcon className="w-5 h-5" />
            </div>
            <div className="grow pl-4">
              <h2 className="mb-1 text-3xl font-bold tracking-wider text-gray-900">
