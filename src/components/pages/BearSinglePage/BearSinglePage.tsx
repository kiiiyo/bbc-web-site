...
export const BearSinglePagePresenter: FC<TBearSinglePagePresenterProps> = ({ state: { collection } }) => {
  return (
    <>
      <Head>
        <title>Bear - {Constants.SITE_TITLE}</title>
      </Head>
              ...
              <div className="pb-20">
                <div className="flex flex-col mx-auto mt-16 lg:flex-row lg:mt-24 lg:w-4/5">
                  ...
                  <div className="w-full lg:pl-10 lg:mt-0 lg:w-1/2">
                    ...
                    <h1 className="mt-4 mb-2 text-3xl font-bold text-gray-900 lg:text-5xl">名前</h1>
                    <p className="mt-6 leading-8">詳細</p>
...
export const BearSinglePage: FC<TBearSinglePageProps> = ({ state: { collection } }) => {
  const {
    state: { locale }
